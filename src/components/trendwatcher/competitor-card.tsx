...
export function CompetitorCard({ item, viewMode }: CompetitorCardProps) {
  ...
  return (
    <div className="rounded-[30px] border border-[#2A3548] bg-[#121822] p-4 shadow-[0_0_0_1px_rgba(255,255,255,0.015)] sm:p-5">
      <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          {sourceIsUrl ? (
            ...
            <p className="mt-2 text-sm text-[#8EA0BE] break-words">{item.source}</p>
          )}
        </div>
      </div>
