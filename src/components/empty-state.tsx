        ...
        <div className="rounded-[32px] border border-[#1E1E1E] bg-[#131313] p-6 sm:p-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="text-3xl font-semibold tracking-tight text-white sm:text-4xl">
              Единая SMM-система для клиентов, наставника и личного кабинета специалиста
            </h2>
            <p className="mt-4 text-sm leading-relaxed text-[#8B93A7] sm:text-base">
              Здесь собрана вся ежедневная работа SMM-команды: клиентские рабочие пространства,
              ИИ-наставник для идей и стратегии, а также личный кабинет специалиста с закреплёнными проектами.
            </p>
          </div>
